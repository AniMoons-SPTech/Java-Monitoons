...
//                        System.out.println(discos.get(0));
                        ...
                        List<RedeInterface> interfaces = redeInterface.getInterfaces();
                        ...
                        Registro registro01 =new Registro(componente01,cpuUso,null,null,cpuFrequencia,null,null, null);
                        Registro registro02 =new Registro(componente02,memUso,null,null,null,memUso,memDisp, null);
                        Registro registro03 =new Registro(componente03,discoUso,velGrav,velLeit,null,discoUso,discoDisp, null);
                        Registro registro04 =new Registro(componente04,videoPorcetUso,null,null,null,gpuMemUso,gpuMemDisp, null);
                        ...
                        System.out.println("\nRedes perto de você:");
                        for (RedeInterface redeInterface1 : interfaces) {
                            System.out.println(redeInterface1.getNomeExibicao());
                        }
