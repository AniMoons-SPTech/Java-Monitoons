...
import org.example.gui.services.AplicativoService;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(processoGrupo.getProcessos().get(0));
        System.out.println(listaJanelas);
        AplicativoService aplicativoService = new AplicativoService();
